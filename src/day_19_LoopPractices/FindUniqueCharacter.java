...
public class FindUniqueCharacter {
    public static void main(String[] args) {
        ...
        for (int j = 0; j < str.length(); j++) {
            ...
            for (int i = 0; i < str.length(); i++) {// compares the character that outher loop picked,with each character of the string
...
char ch='a';                                           sadece bir karekteri kontrol etmek için kullandık
       int count=0;
